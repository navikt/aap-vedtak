...
subgraph Vedtak
	...
	join-1 --> |produced-soker-med-iverksettelse-av-vedtak-buffered| aap.sokere.v1
	...
	join-2 --> |produced-soker-med-kvalitetssikring-11-19-buffered| aap.sokere.v1
	...
	join-3 --> |produced-soker-med-kvalitetssikring-11-2-buffered| aap.sokere.v1
	aap.kvalitetssikring.11-29.v1 --> join-4
	soker-state-store-v2 --> join-4
	join-4 --> |produced-soker-med-kvalitetssikring-11-29-buffered| aap.sokere.v1
	...
	join-5 --> |produced-soker-med-kvalitetssikring-11-3-buffered| aap.sokere.v1
	...
	join-6 --> |produced-soker-med-kvalitetssikring-11-4-buffered| aap.sokere.v1
	...
	join-7 --> |produced-soker-med-kvalitetssikring-11-5-buffered| aap.sokere.v1
	...
	join-8 --> |produced-soker-med-kvalitetssikring-11-6-buffered| aap.sokere.v1
	...
	join-9 --> |produced-soker-med-kvalitetssikring-11-12-buffered| aap.sokere.v1
	...
	join-10 --> |produced-soker-med-manuell-11-19-buffered| aap.sokere.v1
	...
	join-11 --> |produced-soker-med-manuell-11-2-buffered| aap.sokere.v1
	...
	join-12 --> |produced-soker-med-manuell-11-29-buffered| aap.sokere.v1
	...
	join-13 --> |produced-soker-med-manuell-11-3-buffered| aap.sokere.v1
	...
	join-14 --> |produced-soker-med-manuell-11-4-buffered| aap.sokere.v1
	aap.manuell.11-5.v1 --> join-15
	soker-state-store-v2 --> join-15
	join-15 --> |produced-soker-med-manuell-11-5-buffered| aap.sokere.v1
	...
	join-16 --> |produced-soker-med-manuell-11-6-buffered| aap.sokere.v1
	...
	join-17 --> |produced-soker-med-manuell-11-12-buffered| aap.sokere.v1
	...
	join-18 --> |produced-soker-med-sykepengedager-buffered| aap.sokere.v1
	aap.andre-folketrygdytelser.v1 --> join-19
	soker-state-store-v2 --> join-19
	join-19 --> |produced-soker-med-handtert-andre-folketrygdytelser-buffered| aap.sokere.v1
	aap.inntekter.v1 --> join-20
	soker-state-store-v2 --> join-20
	join-20 --> |produced-soker-med-handtert-inntekter-buffered| aap.sokere.v1
	aap.sokere.v1-buffered-joined-aap.medlem.v1-repartition --> join-21
	soker-state-store-v2 --> join-21
	join-21 --> |produced-soker-med-medlem-buffered| aap.sokere.v1
