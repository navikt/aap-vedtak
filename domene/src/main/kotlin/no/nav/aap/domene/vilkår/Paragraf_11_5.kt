...
internal class Paragraf_11_5 private constructor(
    ...
    object SøknadMottatt : Tilstand.SøknadMottatt<Paragraf_11_5>() {
        ...
        override fun toDto(vilkårsvurdering: Paragraf_11_5): VilkårsvurderingModellApi = VilkårsvurderingModellApi(
        ...
        override fun gjenopprettTilstand(vilkårsvurdering: Paragraf_11_5, vilkårsvurderingModellApi: VilkårsvurderingModellApi) {
