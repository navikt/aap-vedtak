...
internal class Paragraf_11_6 private constructor(
    ...
    object SøknadMottatt : Tilstand.SøknadMottatt<Paragraf_11_6>() {
        ...
        override fun toDto(vilkårsvurdering: Paragraf_11_6): VilkårsvurderingModellApi = VilkårsvurderingModellApi(
        ...
        override fun gjenopprettTilstand(vilkårsvurdering: Paragraf_11_6, vilkårsvurderingModellApi: VilkårsvurderingModellApi) {
