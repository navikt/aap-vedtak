...
internal class Paragraf_11_6 private constructor(
    ...
    Vilkårsvurdering(vilkårsvurderingsid, Paragraf.PARAGRAF_11_6, Ledd.LEDD_1) {
    ...
    internal sealed class Tilstand(
        ...
        abstract fun accept(visitor: SøkerVisitor, paragraf: Paragraf_11_6)

        internal open fun onEntry(vilkårsvurdering: Paragraf_11_6, hendelse: Hendelse) {}
        internal open fun onExit(vilkårsvurdering: Paragraf_11_6, hendelse: Hendelse) {}
        ...
        object IkkeVurdert : Tilstand(
            ...
            override fun accept(visitor: SøkerVisitor, paragraf: Paragraf_11_6) =
        ...
        object Oppfylt : Tilstand(
            ...
            override fun accept(visitor: SøkerVisitor, paragraf: Paragraf_11_6) {
                visitor.`preVisit §11-6`(paragraf.løsning)
                visitor.visitVilkårsvurdering(
                    tilstandsnavn = tilstandsnavn.name,
                    vilkårsvurderingsid = paragraf.vilkårsvurderingsid,
                    paragraf = paragraf.paragraf,
                ...
                visitor.`postVisit §11-6`(paragraf.løsning)
            }
        ...
        internal abstract fun toDto(paragraf: Paragraf_11_6): DtoVilkårsvurdering
    }
