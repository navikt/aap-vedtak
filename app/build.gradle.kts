...
dependencies {
    ...
    implementation("com.github.navikt.aap-libs:ktor-utils:2.1.1")
    implementation("com.github.navikt.aap-libs:kafka:2.1.1")
    testImplementation("com.github.navikt.aap-libs:kafka-test:2.1.1")
