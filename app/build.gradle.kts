...
dependencies {
    ...
    implementation("com.github.navikt.aap-libs:ktor-utils:2.0.13")
    implementation("com.github.navikt.aap-libs:kafka:2.0.13")
    testImplementation("com.github.navikt.aap-libs:kafka-test:2.0.13")
