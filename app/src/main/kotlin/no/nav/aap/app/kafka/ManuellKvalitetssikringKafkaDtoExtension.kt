...
internal fun Kvalitetssikring_11_2.håndter(søker: Søker) = toModellApi().håndter(søker)
internal fun Kvalitetssikring_11_3.håndter(søker: Søker) = toModellApi().håndter(søker)
