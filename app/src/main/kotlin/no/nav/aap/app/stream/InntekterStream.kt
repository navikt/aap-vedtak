...
internal fun StreamsBuilder.inntekterStream(
    ...
    consume(Topics.inntekter)
        ...
        .join(Topics.inntekter with Topics.søkere, søkere, buffer, håndterInntekter)
        .produce(Topics.søkere, buffer, "produced-soker-med-handtert-inntekter")
}
