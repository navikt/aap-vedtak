...
internal class ApiTest {
    ...
    @Test
    fun `søker får innvilget vedtak ved løsning fra frontend`() {
        withTestApp { mocks ->
            initializeTopics(mocks.kafka)
            ...
            postLøsning(mocks, """{"løsning_11_5_manuell":{"grad":60}}""")
            postLøsning(mocks, """{"løsning_11_6_manuell":{"erOppfylt":true}}""")
            postLøsning(mocks, """{"løsning_11_12_ledd1_manuell":{"erOppfylt":true}}""")
